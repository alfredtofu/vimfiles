...
" redefine key map, because Shift/Ctrl-F2..F4 generate 'wrong' sequences 
" ^[O1;5Q is generated by press ctrl + v and ctrl + <F2> in INSERT mode.
" O1;2Q is generated by press ctrl + v and ctrl + <F2> in INSERT mode.
:set <F13>=O1;5Q
:set <F14>=O1;2Q
